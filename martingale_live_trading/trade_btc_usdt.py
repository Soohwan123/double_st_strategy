#!/usr/bin/env python3
"""
BTCUSDT Grid Martingale Live Trading
BTC USDT 전용 실시간 자동매매 프로그램

실행: python trade_btc_usdt.py
"""
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info(f"BTCUSDT Grid Martingale Live Trading 시작")
    logger.info("=" * 70)
