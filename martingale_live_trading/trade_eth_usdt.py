#!/usr/bin/env python3
"""
ETHUSDT Grid Martingale Live Trading
ETH USDT 전용 실시간 자동매매 프로그램

실행: python trade_eth_usdt.py
"""
...
SYMBOL_TYPE = 'eth_usdt'
SYMBOL = Config.get_symbol(SYMBOL_TYPE)  # 'ETHUSDT'
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info(f"ETHUSDT Grid Martingale Live Trading 시작")
    logger.info("=" * 70)
