#!/usr/bin/env python3
"""
XRPUSDT Grid Martingale Live Trading
XRP USDT 전용 실시간 자동매매 프로그램

실행: python trade_xrp_usdt.py
"""
...
SYMBOL_TYPE = 'xrp_usdt'
SYMBOL = Config.get_symbol(SYMBOL_TYPE)  # 'XRPUSDT'
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info(f"XRPUSDT Grid Martingale Live Trading 시작")
    logger.info("=" * 70)
