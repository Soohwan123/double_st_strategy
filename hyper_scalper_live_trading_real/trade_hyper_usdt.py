#!/usr/bin/env python3
"""
Hyper Scalper V2 Live Trading (BTCUSDT)
BTC/USDT 15분봉 추세추종 자동매매 프로그램

실행: python trade_hyper_usdt.py
"""
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info("Hyper Scalper V2 Live Trading 시작 (BTCUSDT)")
