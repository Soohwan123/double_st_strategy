...
# 백테스트 기간 설정
# ============================================
START_DATE = '2025-01-09 18:45:00'
END_DATE = '2026-01-14 23:45:00'
...
if __name__ == "__main__":
    ...
    # 결과 저장
    backtester.save_trades('trades_hyper_scalper_v2_usdc.csv')
    backtester.save_data_with_indicators('data_with_hyper_scalper_v2_usdc.csv')
