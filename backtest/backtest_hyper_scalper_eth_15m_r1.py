...
ETH 15m 최적화 Rank 1: 413,116%, MDD 83.46%, WR 61.39%, 1155 trades
Params: ADX=40, ATR=10, TP_L=10, TP_S=2, RST=15, SL=50, RISK=7%
"""
...
if __name__ == "__main__":
    ...
    backtester.save_trades('trades_hyper_scalper_eth_15m_r1.csv')
