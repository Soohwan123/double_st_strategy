"""bt_08 SOL 5m OB SWAP v4 연도별."""
import sys; sys.path.insert(0, '..')
import _common_swap as C
from _common_swap import run_backtest

PARAMS = dict(impulse_lookback=17, impulse_min_pct=0.025, sl_buffer_pct=0.002,
              rr=0.4, max_wait=500, risk_per_trade=0.12, use_htf=True)
...
print(f"\n{'='*78}\n  bt_08 SOL 5m OB SWAP v4 (sanity check)")
